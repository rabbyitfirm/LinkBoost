<?php
// Usage: $activePage, $pageTitle, $pageContent, $modals='', $js='' must be set
$user=currentUser();
?><!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title><?=e($pageTitle??'Admin')?> — <?=e(appName())?> Admin</title>
<link href="https://fonts.googleapis.com/css2?family=Syne:wght@700;800&family=DM+Mono:wght@400;500&display=swap" rel="stylesheet">
<?php include LB_ROOT.'/app/views/layouts/css.php'; ?>
</head><body>
<?php include LB_ROOT.'/app/views/layouts/admin_sidebar.php'; ?>
<div class="main">
<div class="topbar">
  <div class="tb-l"><button class="hbtn" onclick="oSB()">☰</button><div class="tb-title"><?=e($pageTitle??'Admin')?></div></div>
  <div class="tb-r">
    ...
    <a href="<?=e(appUrl())?>" target="_blank" class="btn bs bsm">↗ Site</a>
    <a href="<?=e(appUrl())?>/admin/messages" class="btn bs bsm"><?php
      try{$um=(int)db()->query("SELECT COUNT(*) FROM `".pfx()."contact_messages` WHERE is_read=0")->fetchColumn();if($um)echo "✉️ $um new";}catch(Exception $e){}
    ?></a>
  </div>
</div>
